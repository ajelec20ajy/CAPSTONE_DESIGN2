...
#define DEBUG_LED_4_Pin GPIO_PIN_1
#define DEBUG_LED_4_GPIO_Port GPIOB
...
#define DEBUG_LED_2_GPIO_Port GPIOB
#define DEBUG_LED_3_Pin GPIO_PIN_15
#define DEBUG_LED_3_GPIO_Port GPIOB
